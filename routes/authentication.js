      ...
      if (!req.body.username) {
        ...
        if (!req.body.password) {
          ...
          if (!req.body.region) {
            res.json({
              success: false,
              message: 'You must provide a region!'
            }); // Return error
          } else {
                ...
                if (err.code === 11000) {
                  ...
                  if (err.errors) {
                    ...
                    if (err.errors.email) {
                      ...
                      if (err.errors.username) {
                        ...
                        if (err.errors.password) {
                          ...
                          if (err.errors.region) {
                            res.json({
                              success: false,
                              message: err.errors.region.message
                            }); // Return error
                          } else {
                            res.json({
                              success: false,
                    ...
                    res.json({
                      ...
                      err
                    }); // Return error that is not related to validation
                  }
                }
              } else {
                res.json({
          ...
          if (err) {
            ...
            if (!user) {
              ...
              if (!validPassword) {
                ...
                }); // Return success and token to front-end
              }
            }
          }
        });
